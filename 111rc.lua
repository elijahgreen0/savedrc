...
globalkeys = my_table.join(
    ...
    -- super + ... function keys
    awful.key({ modkey }, "Shift", function () awful.util.spawn( browser1 ) end,
        {description = browser1, group = "function keys"}),
    awful.key({ modkey }, "F2", function () awful.util.spawn( editorgui ) end,
        {description = editorgui , group = "function keys" }),
    awful.key({ modkey }, "m", function () awful.util.spawn( "brave" ) end,
    ...
    awful.key({ modkey }, "a", function () awful.util.spawn( "spotify" ) end,
    ...
    awful.key({ modkey }, "Up", function () awful.util.spawn( "rofi -show run" ) end,
...
clientkeys = my_table.join(
    ...
    awful.key({ modkey, "Space"   }, "Delete",      function (c) c:kill()                         end,
              {description = "close", group = "hotkeys"}),
    awful.key({ modkey, },           "space",      function (c) c:kill()                         end,
              {description = "close", group = "hotkeys"}),
